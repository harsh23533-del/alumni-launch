    ...
    <div className="page" style={{ maxWidth: 560, paddingTop: 60 }}>
      ...
      <div className="row-2">
        ...
        >
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: 14, marginTop: 8 }}>Post a startup and find students to join it.</p>
        </button>
        <button
          className="card"
          style={{ cursor: 'pointer', textAlign: 'left', font: 'inherit', width: '100%' }}
        ...
        >
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: 14, marginTop: 8 }}>Browse startups and apply with your resume.</p>
        </button>
      </div>
    </div>
  );
